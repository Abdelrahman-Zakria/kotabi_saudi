...
import 'exam_models_screen.dart';

class ExamModelsGradesScreen extends StatefulWidget {
  const ExamModelsGradesScreen({super.key});

  @override
  State<ExamModelsGradesScreen> createState() => _ExamModelsGradesScreenState();
}

class _ExamModelsGradesScreenState extends State<ExamModelsGradesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(AppStrings.examModels),
                ...
                itemBuilder: (context, index) {
                  ...
                  return _GradeCard(
                    ...
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => ExamModelsScreen(grade: entry.grade),
                      ),
                    ),
                  );
                },
